...
void setup_pointcloud(std::list<jmk::Point2d>& points)
{
...
int main(void)
{
	...
	std::list<jmk::Vector2f> line_vecs;
	...
	tree.getSplitLineData(line_vecs);
	getLineDataFromPoints2D(line_vecs, line_data);
